...
class ProjectDetails(BaseModel):
    ...
    # Legislation reference for an OTHER location, worded like the built-in
    # ones, e.g. "Building Bye Laws (Jersey) 2007 (Part 2)". Blank falls back
    # to the England/Wales reference.
    legislation: str = ""
